...
abstract public class VOUserHelper
{
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[5] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          _tcOf_members0 = chat.supertopeerHelper.type ();
          _members0[6] = new org.omg.CORBA.StructMember (
            "callback",
            _tcOf_members0,
            null);
          _tcOf_members0 = chat.peertopeerHelper.type ();
  ...
  public static chat.VOUser read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value.callback = chat.supertopeerHelper.read (istream);
    value.chat = chat.peertopeerHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, chat.VOUser value)
  {
    ...
    chat.supertopeerHelper.write (ostream, value.callback);
    chat.peertopeerHelper.write (ostream, value.chat);
  }
