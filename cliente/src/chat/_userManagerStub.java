...
public class _userManagerStub extends org.omg.CORBA.portable.ObjectImpl implements chat.userManager
{
  ...
  public chat.VOUser[] getUserLike (chat.VOUser usuario, chat.VOUser busqueda)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getUserLike", true);
                chat.VOUserHelper.write ($out, usuario);
                chat.VOUserHelper.write ($out, busqueda);
                $in = _invoke ($out);
                chat.VOUser $result[] = chat.listaUsuariosHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                ...
                return getUserLike (usuario, busqueda        );
            } finally {
                _releaseReply ($in);
            }
  } // getUserLike
