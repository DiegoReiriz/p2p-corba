...
public class _userManagerStub extends org.omg.CORBA.portable.ObjectImpl implements chat.userManager
{
  ...
  public boolean getFrindList (chat.VOUser usuario, chat.listaUsuariosHolder usuarios)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getFrindList", true);
                chat.VOUserHelper.write ($out, usuario);
                chat.listaUsuariosHelper.write ($out, usuarios.value);
                $in = _invoke ($out);
                boolean $result = $in.read_boolean ();
                usuarios.value = chat.listaUsuariosHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                return getFrindList (usuario, usuarios        );
            } finally {
                _releaseReply ($in);
            }
  } // getFrindList
