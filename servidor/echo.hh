...
_CORBA_MODULE ECHOAPP

_CORBA_MODULE_BEG

#ifndef __ECHOAPP_mEcho__
#define __ECHOAPP_mEcho__
  class Echo;
  class _objref_Echo;
  class _impl_Echo;
...
_CORBA_MODULE POA_ECHOAPP
_CORBA_MODULE_BEG

  class Echo :
    public virtual ECHOAPP::_impl_Echo,
    public virtual ::PortableServer::ServantBase
  {
  public:
    virtual ~Echo();

    inline ::ECHOAPP::Echo_ptr _this() {
      return (::ECHOAPP::Echo_ptr) _do_this(::ECHOAPP::Echo::_PD_repoId);
    }
  };
...
inline void
ECHOAPP::Echo::_marshalObjRef(::ECHOAPP::Echo_ptr obj, cdrStream& s) {
